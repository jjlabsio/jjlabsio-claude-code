...
- Be specific: use exact file paths, function names, variable names when describing what was *found* in analysis
- This output is for internal planning only — file paths and component names found here should NOT be carried over into the final plan
